#ifndef __GX3211_CLOCK_REG_H__
#define __GX3211_CLOCK_REG_H__
...
#define DTO_PLL_F	(REG_GET_FIELD(&(gx3211_clock_reg->cfg_pll4), DTO_PLL_F_MASK, BIT_DTO_PLL_F))
#define DTO_PLL_R	(REG_GET_FIELD(&(gx3211_clock_reg->cfg_pll4), DTO_PLL_R_MASK, BIT_DTO_PLL_R))
#define DTO_PLL_OD	(REG_GET_FIELD(&(gx3211_clock_reg->cfg_pll4), DTO_PLL_OD_MASK, BIT_DTO_PLL_OD))
...
struct clock_regs {
	...
	unsigned int   cfg_resv0[6];
	unsigned int   cfg_mpeg_clk_inhibit2_norm;   /* 0x68 */
	unsigned int   cfg_resv1[21];
...
#define CFG_AUDIO_LODAC_CLOCK_ENABLE(base) \
	REG_CLR_BIT(&(base->cfg_mpeg_clk_inhibit2_norm), 0x7)

#define CFG_AUDIO_LODAC_CLOCK_DISABLE(base) \
	REG_SET_BIT(&(base->cfg_mpeg_clk_inhibit2_norm), 0x7)
...
#define CFG_VIDEO0_COLD_SET(base) \
    REG_SET_BIT(&(gx3211_clock_reg->cfg_mpeg_cold_reset), 22)

#define CFG_VIDEO0_COLD_CLR(base) \
    REG_CLR_BIT(&(gx3211_clock_reg->cfg_mpeg_cold_reset), 22)

#define CFG_VIDEO1_COLD_SET(base) \
    REG_SET_BIT(&(gx3211_clock_reg->cfg_mpeg_cold_rst_2_1set), 4)

#define CFG_VIDEO1_COLD_CLR(base) \
    REG_CLR_BIT(&(gx3211_clock_reg->cfg_mpeg_cold_rst_2_1set), 4)
