#ifndef __GX3201_CLOCK_REG_H__
#define __GX3201_CLOCK_REG_H__
...
#define DTO_PLL_F	(REG_GET_FIELD(&(gx3201_clock_reg->cfg_pll4), DTO_PLL_F_MASK, BIT_DTO_PLL_F))
#define DTO_PLL_R	(REG_GET_FIELD(&(gx3201_clock_reg->cfg_pll4), DTO_PLL_R_MASK, BIT_DTO_PLL_R))
#define DTO_PLL_OD	(REG_GET_FIELD(&(gx3201_clock_reg->cfg_pll4), DTO_PLL_OD_MASK, BIT_DTO_PLL_OD))
...
#define CFG_VIDEO0_COLD_SET(base) \
    REG_SET_BIT(&(gx3201_clock_reg->cfg_mpeg_cold_reset), 22)

#define CFG_VIDEO0_COLD_CLR(base) \
    REG_CLR_BIT(&(gx3201_clock_reg->cfg_mpeg_cold_reset), 22)

#define CFG_VIDEO1_COLD_SET(base) \
    REG_SET_BIT(&(gx3201_clock_reg->cfg_mpeg_cold_rst_2_1set), 4)

#define CFG_VIDEO1_COLD_CLR(base) \
    REG_CLR_BIT(&(gx3201_clock_reg->cfg_mpeg_cold_rst_2_1set), 4)
