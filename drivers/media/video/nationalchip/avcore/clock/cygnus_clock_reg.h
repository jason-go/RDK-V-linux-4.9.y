#ifndef __CYGNUS_CLOCK_REG_H__
#define __CYGNUS_CLOCK_REG_H__
...
#define DTO_PLL_F	(REG_GET_FIELD(&(cygnus_clock_reg->cfg_pll4), DTO_PLL_F_MASK, BIT_DTO_PLL_F))
#define DTO_PLL_R	(REG_GET_FIELD(&(cygnus_clock_reg->cfg_pll4), DTO_PLL_R_MASK, BIT_DTO_PLL_R))
#define DTO_PLL_OD	(REG_GET_FIELD(&(cygnus_clock_reg->cfg_pll4), DTO_PLL_OD_MASK, BIT_DTO_PLL_OD))
...
#define CFG_VIDEO0_COLD_SET(base) \
    REG_SET_BIT(&(cygnus_clock_reg->cfg_mpeg_cold_reset), 22)

#define CFG_VIDEO0_COLD_CLR(base) \
    REG_CLR_BIT(&(cygnus_clock_reg->cfg_mpeg_cold_reset), 22)

#define CFG_VIDEO1_COLD_SET(base) \
    REG_SET_BIT(&(cygnus_clock_reg->cfg_mpeg_hot_reset2_set), 4)

#define CFG_VIDEO1_COLD_CLR(base) \
    REG_CLR_BIT(&(cygnus_clock_reg->cfg_mpeg_hot_reset2_set), 4)
