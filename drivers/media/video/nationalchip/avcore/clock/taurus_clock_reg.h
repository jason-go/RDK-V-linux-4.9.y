#ifndef __TAURUS_CLOCK_REG_H__
#define __TAURUS_CLOCK_REG_H__
...
#define DTO_PLL_F	(REG_GET_FIELD(&(taurus_clock_reg->cfg_pll4), DTO_PLL_F_MASK, BIT_DTO_PLL_F))
#define DTO_PLL_R	(REG_GET_FIELD(&(taurus_clock_reg->cfg_pll4), DTO_PLL_R_MASK, BIT_DTO_PLL_R))
#define DTO_PLL_OD	(REG_GET_FIELD(&(taurus_clock_reg->cfg_pll4), DTO_PLL_OD_MASK, BIT_DTO_PLL_OD))
...
#define CFG_VIDEOOUT0_HOT_SET(base) \
    REG_SET_VAL(&(base->cfg_mpeg_hot_reset_set), 0x1<<28)

#define CFG_VIDEOOUT0_HOT_CLR(base) \
    REG_SET_VAL(&(base->cfg_mpeg_hot_reset_clr), 0x1<<28)
...
#define CFG_VIDEO0_COLD_SET(base) \
    REG_SET_VAL(&(taurus_clock_reg->cfg_mpeg_cold_reset_set), 0x1<<28)

#define CFG_VIDEO0_COLD_CLR(base) \
    REG_SET_VAL(&(taurus_clock_reg->cfg_mpeg_cold_reset_clr), 0x1<<28)

#define CFG_VIDEO1_COLD_SET(base) \
    REG_SET_BIT(&(taurus_clock_reg->cfg_mpeg_hot_reset2_set), 4)

#define CFG_VIDEO1_COLD_CLR(base) \
    REG_CLR_BIT(&(taurus_clock_reg->cfg_mpeg_hot_reset2_set), 4)
