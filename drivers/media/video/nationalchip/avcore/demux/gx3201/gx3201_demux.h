#ifndef __GX3201_DEMUX_H__
#define __GX3201_DEMUX_H__
...
#define MAX_CA_NUM               26
#define MAX_AVBUF_NUM            8
...
extern struct dmxdev gx3201_dmx;
...
void         gx3201_dmx_query_tslock  (struct dmx_demux *dmx);

void         gx3201_dmx_pcr_sync      (struct dmxdev *demux_device, int demux_id, unsigned short pcr_pid);
void         gx3201_dmx_read_stc      (unsigned int *value);
int          gx3201_dmx_read_apts     (void);
int          gx3201_dmx_read_pcr      (void);
void         gx3201_dmx_write_apts    (unsigned int value, int immd);
void         gx3201_dmx_write_vpts    (unsigned int value, int immd);

void         gx3201_dmx_stc_set(unsigned int value, int immd);
