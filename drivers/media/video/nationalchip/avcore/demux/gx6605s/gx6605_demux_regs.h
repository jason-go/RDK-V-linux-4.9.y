...
#ifndef _GX6605_DEMUX_REGS_H
#define _GX6605_DEMUX_REGS_H
...
#define NUM_PID_CFG_SEL                    32    // num of PID_CFG & PID_SEL
#define NUM_KEY_PAIR                       16    // gx6605...have 12 pair of keys
#define NUM_MATCH_BIT                      8
#define NUM_MATCH_BYTE                     16
#define NUM_DF_DEPTH                       8
#define NUM_DF_CHNL                        32
#define NUM_AV_CHNL                        4
...
#define BIT_DEMUX_PID_CFG_TSW_BUF          23
...
#define DEMUX_PID_CFG_TSW_BUF_SEL          (0x1f << BIT_DEMUX_PID_CFG_TSW_BUF)
...
#define BIT_DEMUX_STC_ENABLE            (16)
#define BIT_DEMUX_STC_REVERSE           (22)
#define BIT_DEMUX_STC_PAUSE             (21)
#define BIT_DEMUX_STC_UPDATE            (20)
...
struct reg_demux {
	struct reg_demux_pid_enable pidf_en[2];
	unsigned int reservedf;
	struct reg_demux_pid pidf[NUM_PID_BIT];
	struct reg_demux_slot pid_cfg_self[NUM_PID_CFG_SEL];
	unsigned int reserved_af[240];
	...
	unsigned int reserved_b[368];

	struct reg_demux_byte m_byte_n[NUM_MATCH_BYTE];

	unsigned int reserved_g[256];
	...
	unsigned int reserve_o[32];
	struct reg_demux_avaddr av_addr[NUM_AV_CHNL];
	unsigned int reserve_p[32];
	...
	unsigned int reserve_r[8];
	unsigned int pts_w_addr[NUM_AV_CHNL];
	unsigned int reserve_d[5];
	...
	unsigned int descramble_sel;
};


#endif /*_GX6605_DEMUX_REGS_H*/
