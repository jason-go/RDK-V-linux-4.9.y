#ifndef __GX3201_VIDEO_OUT_REG_H__
#define __GX3201_VIDEO_OUT_REG_H__

#include "gxav_bitops.h"

#define VOUT_HDMI_INT_SRC   (54)
#define TV_VOUT0_BASE_ADDR  (0x04804000)
#define TV_VOUT1_BASE_ADDR  (0x04904000)

struct gx3201_videoout_reg
{
...
#define bYUV_TRAN_Y_SCALE0              (11)
#define bYUV_TRAN_Y_SCALE1              (0)
#define bYUV_TRAN_Y_SCALE2              (0)

#define mYUV_TRAN_Y_SCALE0              (0x7ff  << bYUV_TRAN_Y_SCALE0       )
#define mYUV_TRAN_Y_SCALE1              (0x7ff  << bYUV_TRAN_Y_SCALE1       )
#define mYUV_TRAN_Y_SCALE2              (0x7ff  << bYUV_TRAN_Y_SCALE2       )
...
#define bYUV_TRAN_U_SCALE0              (11)
#define bYUV_TRAN_U_SCALE1              (0)
#define bYUV_TRAN_U_SCALE2              (0)

#define mYUV_TRAN_U_SCALE0              (0x7ff  << bYUV_TRAN_U_SCALE0       )
#define mYUV_TRAN_U_SCALE1              (0x7ff  << bYUV_TRAN_U_SCALE1       )
#define mYUV_TRAN_U_SCALE2              (0x7ff  << bYUV_TRAN_U_SCALE2       )

/* Definition of register rYUV_TRAN_V's bit, mask, value */
#define bYUV_TRAN_V_SCALE0              (11)
#define bYUV_TRAN_V_SCALE1              (0)
#define bYUV_TRAN_V_SCALE2              (0)

#define mYUV_TRAN_V_SCALE0              (0x7ff  << bYUV_TRAN_V_SCALE0       )
#define mYUV_TRAN_V_SCALE1              (0x7ff  << bYUV_TRAN_V_SCALE1       )
#define mYUV_TRAN_V_SCALE2              (0x7ff  << bYUV_TRAN_V_SCALE2       )
...
#define DVE_GET_YUV_TRAN_Y_SCALE0(rp)                             \
	REG_GET_FIELD(                                                  \
			&(rp->yuv_tran_y1),                             \
			mYUV_TRAN_Y_SCALE0,                             \
			bYUV_TRAN_Y_SCALE0)

#define DVE_SET_YUV_TRAN_Y_SCALE1(rp,value)                             \
	REG_SET_FIELD(                                                  \
			&(rp->yuv_tran_y1),                             \
			mYUV_TRAN_Y_SCALE1,                             \
			value,						\
...
#define DVE_SET_YUV_TRAN_Y_SCALE2(rp,value)                             \
	REG_SET_FIELD(                                                  \
			&(rp->yuv_tran_y2),                             \
			mYUV_TRAN_Y_SCALE2,                             \
			value,						\
...
//COLR_TRAN_M1(U)
#define DVE_SET_YUV_TRAN_U_SCALE0(rp,value)                             \
	REG_SET_FIELD(                                                  \
			&(rp->yuv_tran_u1),                             \
			mYUV_TRAN_U_SCALE0,                             \
			value,						\
...
#define DVE_GET_YUV_TRAN_U_SCALE1(rp)                             \
	REG_GET_FIELD(                                                  \
			&(rp->yuv_tran_u1),                             \
			mYUV_TRAN_U_SCALE1,                             \
			bYUV_TRAN_U_SCALE1)

#define DVE_SET_YUV_TRAN_U_SCALE2(rp,value)                             \
	REG_SET_FIELD(                                                  \
			&(rp->yuv_tran_u2),                             \
			mYUV_TRAN_U_SCALE2,                             \
			value,						\
...
//COLR_TRAN_M2(V)
#define DVE_SET_YUV_TRAN_V_SCALE0(rp,value)                             \
	REG_SET_FIELD(                                                  \
			&(rp->yuv_tran_v1),                             \
			mYUV_TRAN_V_SCALE0,                             \
			value,						\
...
#define DVE_SET_YUV_TRAN_V_SCALE1(rp,value)                             \
	REG_SET_FIELD(                                                  \
			&(rp->yuv_tran_v1),                             \
			mYUV_TRAN_V_SCALE1,                             \
			value,						\
...
#define DVE_GET_YUV_TRAN_V_SCALE2(rp)                             \
	REG_GET_FIELD(                                                  \
			&(rp->yuv_tran_v2),                             \
			mYUV_TRAN_V_SCALE2,                             \
			bYUV_TRAN_V_SCALE2)
