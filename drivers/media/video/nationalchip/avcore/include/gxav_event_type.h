...
#define EVENT_AUDIO_FRAMEINFO                    0x00001000
#define EVENT_AUDIO_KEY                          0x00002000
#define EVENT_AUDIO_DECODE_ERROR                 0x00004000
...
#define EVENT_VIDEO_SEQ_CHANGED                  (1 << 6)
...
#define EVENT_HDMI_CEC_EOM                       0x00000080
...
#define EVENT_MODULE_FULL(i)                     (1UL << (i + 16))
#define EVENT_MODULE_EMPTY(i)                    (1UL << (i + 24))
