 ...
 *      set protect space (0x10000000 ~ 0x10200000)，set master A7/MAC/USB/NFC has read permission, master GSE/A7/VPU has write permission
 *
 */
...
/*
 * Gx_Firewall_Protect_Buffer
 *
 *  DESCRIPTION
 *      The type of protected memory area
 *
 */
enum Gx_Firewall_Protect_Buffer {
	GXFW_BUFFER_DEMUX_ES       = (1 << 0),
	GXFW_BUFFER_DEMUX_TSW      = (1 << 1),
	GXFW_BUFFER_DEMUX_TSR      = (1 << 2),
	GXFW_BUFFER_GP_ES          = (1 << 3),
	GXFW_BUFFER_AUDIO_FIRMWARE = (1 << 4),
	GXFW_BUFFER_AUDIO_FRAME    = (1 << 5),
	GXFW_BUFFER_VIDEO_FIRMWARE = (1 << 6),
	GXFW_BUFFER_VIDEO_FRAME    = (1 << 7),
	GXFW_BUFFER_VPU_CAP        = (1 << 8),
	GXFW_BUFFER_SCPU           = (1 << 9),
	GXFW_BUFFER_SOFT           = (1 << 15),
};
 ...
 *
 *  RETURN VALUE
 *      On success, the type of protected memory area is returned
 *      On error, a negative value is returned
 *
 *  NOTES
