...
#ifndef _GX3211_MTC_REG_H_201506122003_
#define _GX3211_MTC_REG_H_201506122003_
...
#define bMTC_DES_IV_SELECT               (28)
#define bMTC_MEMORY_KEY_USE_LOW          (27)
#define bMTC_READ_MEMORY_KEY_ENABLE      (26)
...
#define MTC_DES_IV_SELECT_T(base)  REG_SET_BIT(&(base->MTC_CTRL1),bMTC_DES_IV_SELECT)
#define MTC_DES_IV_SELECT_F(base)  REG_CLR_BIT(&(base->MTC_CTRL1),bMTC_DES_IV_SELECT)

#define MTC_MEMORY_KEY_USE_LOW_T(base) REG_SET_BIT(&(base->MTC_CTRL1),bMTC_MEMORY_KEY_USE_LOW)
#define MTC_MEMORY_KEY_USE_LOW_F(base) REG_CLR_BIT(&(base->MTC_CTRL1),bMTC_MEMORY_KEY_USE_LOW)

#define MTC_READ_MEMORY_KEY_ENABLE_T(base) REG_SET_BIT(&(base->MTC_CTRL1),bMTC_READ_MEMORY_KEY_ENABLE)
#define MTC_READ_MEMORY_KEY_ENABLE_F(base) REG_CLR_BIT(&(base->MTC_CTRL1),bMTC_READ_MEMORY_KEY_ENABLE)
...
#define wMTCR_SDR_START_ADDR   (0x0FFFFFFF)
...
#define wMTCW_SDR_START_ADDR   (0x0FFFFFFF)
...
////
#define bMTC_READ_MEMORY_KEY_READY      (5) // 3211
...
#define MTC_READ_MEMORY_KEY_READY_T(base)  REG_SET_BIT(&(base->MTC_CTRL2),bMTC_READ_MEMORY_KEY_READY)
#define MTC_READ_MEMORY_KEY_READY_F(base)  REG_CLR_BIT(&(base->MTC_CTRL2),bMTC_READ_MEMORY_KEY_READY)
...
////
#define bMTC_DMCW_READY                  (7)
#define bMTC_DVCW_READY                  (6)
...
#define MTC_DMCW_READY_T(base)  REG_SET_BIT(&(base->MTC_CA_MODE),bMTC_DMCW_READY)
#define MTC_DMCW_READY_F(base)  REG_CLR_BIT(&(base->MTC_CA_MODE),bMTC_DMCW_READY)

#define MTC_DVCW_READY_T(base)  REG_SET_BIT(&(base->MTC_CA_MODE),bMTC_DVCW_READY)
#define MTC_DVCW_READY_F(base)  REG_CLR_BIT(&(base->MTC_CA_MODE),bMTC_DVCW_READY)
...
#define MTC_MEMORY_KEY_WRITE_ADDR(base, value)    \
    REG_SET_FIELD(&(base->MTC_MEMORY_KEY_WRITE_ADDR),mMTC_MEMORY_KEY_WRITE_ADDR,(value & wMTC_MEMORY_KEY_WRITE_ADDR),bMTC_MEMORY_KEY_WRITE_ADDR)


////
#define bMTC_CW_5_ROUND                  (13)
#define bMTC_CW_4_ROUND                  (12)
#define bMTC_CW_0_ROUND_VALID            (11)
#define bMTC_CW_0_ROUND                  (10)
...
#define MTC_CW_5_ROUND_T(base)  REG_SET_BIT(&(base->MTC_CW_SELECT),bMTC_CW_5_ROUND)
#define MTC_CW_5_ROUND_F(base)  REG_CLR_BIT(&(base->MTC_CW_SELECT),bMTC_CW_5_ROUND)

#define MTC_CW_4_ROUND_T(base)  REG_SET_BIT(&(base->MTC_CW_SELECT),bMTC_CW_4_ROUND)
#define MTC_CW_4_ROUND_F(base)  REG_CLR_BIT(&(base->MTC_CW_SELECT),bMTC_CW_4_ROUND)

#define MTC_CW_0_ROUND_VALID_T(base)  REG_SET_BIT(&(base->MTC_CW_SELECT),bMTC_CW_0_ROUND_VALID)
#define MTC_CW_0_ROUND_VALID_F(base)  REG_CLR_BIT(&(base->MTC_CW_SELECT),bMTC_CW_0_ROUND_VALID)

#define MTC_CW_0_ROUND_T(base)  REG_SET_BIT(&(base->MTC_CW_SELECT),bMTC_CW_0_ROUND)
#define MTC_CW_0_ROUND_F(base)  REG_CLR_BIT(&(base->MTC_CW_SELECT),bMTC_CW_0_ROUND)
...
#define MTC_DATA_FINISH_INTERRUPT_EN_T(base)  REG_SET_BIT(&(base->MTC_INT_EN),bMTC_DATA_FINISH_INT_EN)
#define MTC_DATA_FINISH_INTERRUPT_EN_F(base)  REG_CLR_BIT(&(base->MTC_INT_EN),bMTC_DATA_FINISH_INT_EN)
...
////
#define MTC_DSK_VALUE_BY_INDEX(base,id,value)  REG_SET_VAL(&(base->MTC_CA_DSK[id]),value)
////
#define MTC_DCK_VALUE_BY_INDEX(base,id,value)  REG_SET_VAL(&(base->MTC_CA_DCK[id]),value)
////
#define MTC_DCW_VALUE_BY_INDEX(base,id,value)  REG_SET_VAL(&(base->MTC_CA_DCW[id]),value)
////
#define MTC_VCW_VALUE_BY_INDEX(base,id,value)  REG_SET_VAL(&(base->MTC_CA_VCW[id]),value)
////
#define MTC_MCW_VALUE_BY_INDEX(base,id,value)  REG_SET_VAL(&(base->MTC_CA_MCW[id]),value)
////
...
typedef struct MTC_Regs_s
{
	...
	unsigned int     MTC_COUNTER[4]  ;         // 0x34  0x38 0x3c 0x40
	unsigned int     MTC_IV1[4] ;              // 0x44  0x48 0x4c 0x50
	...
	unsigned int     MTC_reveser1[11] ;        // 0x64,68,6c ,70~7c,80~8c
	...
	unsigned int     MTC_reverser3[28];        // 0xb0,c0,d0,e0,f0,100,110,11c
	...
	unsigned int     reverser4[3];         // 0x144,148,14c
	unsigned int     MTC_CA_K3_GEN ;           // 0x150
	unsigned int     reverser5[3];         // 0x154,158,15c
	unsigned int     MTC_INT_EN ;          // 0x160
	unsigned int     MTC_INT    ;          // 0x164
	unsigned int     reverser6[6];         // 0x168,170,17c
	unsigned int     MTC_IV2[4] ;              // 0x180 0x184 0x188 0x18C
	unsigned int     reverser7[28] ;       // 0x190,1a0,1b0,1c0,1d0,1e0,1f0,1fc
	unsigned int     MTC_CA_DSK[6] ;           // 0x200 204 208 20c 210 214
	unsigned int     reverser8[2];         // 0x218,0x21c
	unsigned int     MTC_CA_DCK[6] ;           // 0x220 224 228 22c 230 234
	unsigned int     reverser9[2];         // 0x238,0x23c
	unsigned int     MTC_CA_DCW[6] ;           // 0x240 244 248 24c 250 254
	unsigned int     reverserA[2];         // 0x258,0x25c
	unsigned int     MTC_CA_VCW[6] ;           // 0x260 264 268 26c 270 274
	unsigned int     reverserB[2];         // 0x278,0x27c
	unsigned int     MTC_CA_MCW[6] ;           // 0x280 284 288 28c 290 294
