...
/* constants */
#define USER_BIT		(0)
#define AUDIO_DMA_DONE	(1 << 7)
#define AUDIO_DMA_ERROR (1 << 4)
/**
 ...
 * @param baseAddr base Address of controller
 * @param mask of fields to be enabled of the interrupt register
 */
void audio_DmaInterruptEnable(u16 baseAddr, u8 mask);
/**
 * Disable Audio DMA interrupts
 * @param baseAddr base Address of controller
 * @param mask of fields to be disabled of the interrupt register
 */
