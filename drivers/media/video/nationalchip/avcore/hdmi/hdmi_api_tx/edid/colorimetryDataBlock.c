...
int colorimetryDataBlock_SupportsSYcc601(colorimetryDataBlock_t * cdb)
{
	return (bitOperation_BitField(cdb->mByte3, 2, 1) == 1) ? TRUE : FALSE;
}

int colorimetryDataBlock_SupportsAdobeYcc601(colorimetryDataBlock_t * cdb)
{
	return (bitOperation_BitField(cdb->mByte3, 3, 1) == 1) ? TRUE : FALSE;
}

int colorimetryDataBlock_SupportsAdobeRgb(colorimetryDataBlock_t * cdb)
{
	return (bitOperation_BitField(cdb->mByte3, 4, 1) == 1) ? TRUE : FALSE;
}
...
int colorimetryDataBlock_SupportsMetadata3(colorimetryDataBlock_t * cdb)
{
	return (bitOperation_BitField(cdb->mByte4, 3, 1) == 1) ? TRUE : FALSE;
}
