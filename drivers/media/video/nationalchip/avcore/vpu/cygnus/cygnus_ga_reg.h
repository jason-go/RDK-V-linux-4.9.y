#ifndef __CYGNUS_GA_REG_H__
#define __CYGNUS_GA_REG_H__
...
#define GA_HOT_RESET()\
do {\
	extern volatile struct config_regs *cygnus_config_reg;\
	REG_SET_BIT(&(cygnus_config_reg->cfg_mpeg_hot_reset), 5);\
	gx_mdelay(1);\
	REG_CLR_BIT(&(cygnus_config_reg->cfg_mpeg_hot_reset), 5);\
}while(0)
