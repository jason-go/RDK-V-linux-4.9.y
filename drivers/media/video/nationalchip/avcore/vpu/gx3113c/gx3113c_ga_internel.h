#ifndef __GX3113c_GA_INTERNEL_H__
#define __GX3113c_GA_INTERNEL_H__

#include "kernelcalls.h"
#include "gx3113c_vpu.h"
#include "gx3113c_ga_reg.h"
...
#define GA_INC_SRC          (62)
#define GA_REG_BASE_ADDR    (0x04700000)
...
typedef struct _GaJob {
	...
	void        *cmd_start_addr;
	void        *cct_start_addr;
	unsigned int dummy;//cmd addr 8byte aligned
}GaJob;
...
do {\
	...
	if(channel->width>0x3FFF || channel->height>0x3FFF)\
		return GA_RET_FAIL;\
