...
static int btrtl_setup_rtl8723b(struct hci_dev *hdev, u16 lmp_ver,u16 lmp_subver,
				const char *fw_name)
{
	...
	case RTL_ROM_LMP_8761A:
		...
		else if(lmp_ver == 0x0a)
			cfg_name = "rtl_bt/rtl8761bu_config.bin";
		else
			cfg_name = "rtl_bt/rtl8761a_config.bin";
		break;
...
int btrtl_setup_realtek(struct hci_dev *hdev)
{
	...
	u16 lmp_ver,lmp_subver;
	
	msleep(500); /*fixup Direct firmware load for .... failed with error -2*/
	...
	lmp_ver = le16_to_cpu(resp->lmp_ver);
	...
	case RTL_ROM_LMP_8723B:
		return btrtl_setup_rtl8723b(hdev, lmp_ver,lmp_subver,
